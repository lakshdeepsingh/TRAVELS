...
public class RegisterFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String cpass = request.getParameter("confirmedpassword");
        String fail = "UserName Already exists !!! Please try a different username";
        ...
        try
            {
                ...
                PreparedStatement stmt=con.prepareCall("select * from emp1") ;
                ...
                while(rs.next())
                {
                    ...
                    {
                        flag=0;
                        request.setAttribute("attr", fail);
        ...
        if(pass.equalsIgnoreCase(cpass) && flag==1)
        {
            out.print("TRANSFERRING CODE TO SERVLET FOR INSERTION");
             try {
        ...
        {
            String unsuccess = "OOPS!!Your confirmed password does not match your entered password!!!!!Please try again";
